...
\author[icl]{A.C.J.˜Cutmore\corref{cor1}\fnref{pn1}}
\ead{adam.cutmore08@imperial.ac.uk}

\author[icl]{W.J.˜Knottenbelt\fnref{pn1}}
\ead{w.knottenbelt@imperial.ac.uk}

\cortext[cor1]{Corresponding author}

\fntext[pn1]{\textit{Phone numbers: }+447847051549 (A.C.J.Cutmore), +442075948331 (W.J.Knottenbelt)}
...
\begin{figure}[H]
\includegraphics[width=12.5cm]{djokovicnadal}
\centering
...
\begin{figure}[h!]
  \centering \includegraphics[width=12.5cm]{murrayberrer}
...
\begin{figure}[H]
\centering \includegraphics[width=12.5cm]{artificialfirstset}
...
\begin{figure}[H]
\centering \includegraphics[width=12.5cm]{artificialretirement}
...
\begin{figure}[H]
  \centering \includegraphics[width=12.3cm]{murrayberrermodel}
...
\begin{figure}[H]
  \centering \includegraphics[width=12.3cm]{murrayberrerrisk}
...
\begin{figure}[H]
  \centering \includegraphics[width=12.3cm]{azarenkasharapova}
